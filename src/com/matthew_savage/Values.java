...
public enum Values {
    ...
    DB_COL_FAVE_BOOL ("title_id"),
    DB_COL_VER ("version"),
    DB_COL_TITLE_TOT ("titles_total"),
    DB_COL_READING_TOT("reading_total"),
    DB_COL_FIN_TOT ("finished_reading"),
    DB_COL_PAGES_TOT ("pages_read"),
    DB_COL_FAVE_TOT ("favorites"),
    DB_COL_BL_TOT ("blacklisted"),
    DB_COL_PAGES_DAY ("pages_daily"),
    DB_COL_GEN_ONE ("first_genre"),
    DB_COL_GEN_TWO ("second_genre"),
    DB_COL_GEN_THREE ("third_genre"),
